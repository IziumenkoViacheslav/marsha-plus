...
export interface MyTokenInterface extends utils.Interface {
  functions: {
    ...
    "artistCommissionPercentage()": FunctionFragment;
    ...
    "setArtistCommission(uint256)": FunctionFragment;
    "supportsInterface(bytes4)": FunctionFragment;
    "symbol()": FunctionFragment;
    "tokenToArtist(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "artistCommissionPercentage",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setArtistCommission",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface MyToken extends BaseContract {
  ...
  functions: {
    ...
    artistCommissionPercentage(overrides?: CallOverrides): Promise<[BigNumber]>;
